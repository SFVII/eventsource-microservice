...
class EventConsumer<Contributor> {
	...
	constructor(EvenStoreConfig: IEvenStoreConfig, StreamName: string, queue: IQueue | IQueueCustom = {
					create: [], update: [], delete: [], recover: []}, publish: boolean = false, group: IEventHandlerGroup = 'consumers') {
