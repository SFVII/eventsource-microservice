...
class EventsPlugin extends DataTreated {
    constructor(EvenStoreConfig, streamName, methods, causationRoute) {
        ...
        const group = (0, Utils_1.getQueueName)(streamName);
        streamName = (0, Utils_1.ServiceNamePatternSplitter)(streamName);
        console.log('THIS IS MY STREAM_NAME', streamName);
        if (process.env.PEERJS_SERVER) {
            this.broker = new SocketClient_1.BrokerSocketClient(streamName, process.env.PEERJS_SERVER);
        }
