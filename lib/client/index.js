...
class EventsPlugin {
    constructor(EvenStoreConfig, streamName, methods, causationRoute) {
        ...
        for (const method of this.methods) {
            // @ts-ignore
            this[method] = async (data, typeOrigin, streamName, causationRoute) => {
                const { payload, requestId } = await this.EventMiddlewareEmitter(data, method, streamName, causationRoute, typeOrigin);
                return {
                    data: payload,
    ...
    async EventMiddlewareEmitter(data, method, _streamName, causationRoute, typeOrigin) {
