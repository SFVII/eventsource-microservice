...
const ReplicateIdentifier = () => {
    let replicateIdentifier = '';
    if (process.env.REPLICAT_ID) {
        replicateIdentifier = "_" + process.env.REPLICAT_ID;
    }
    return replicateIdentifier;
};
...
class EventsPlugin extends DataTreated {
    constructor(EvenStoreConfig, streamName, methods, causationRoute) {
        ...
        this.streamName = streamName + ReplicateIdentifier();
        this._pendingTemplates[this.streamName] = [];
